# 2005/01/06 - v2.1.0 by Michael Foord
# 2005.09.28 - v2.1.1 by Jinsong Ren. Added 'mute_stdout' attribute. 
#              When it's True: mute stdout output. Default is False.
...
class StandOut:
    """
    2005.09.28 - Jinsong Ren. Added 'mute_stdout' attribute. 
                 True: mute stdout output.
                 False:(Default) print to stdout.
    """
    stdout = None
    stderr = None
    def __init__(self, indict = {}, **keywargs):
        ...
        self.mute_stdout = indict['mute_stdout'] #jr+
